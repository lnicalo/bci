...
% p1 = 0:0.01:0.2;
p1 = 20:2:80;
% p1 = 1:20:320; p2 = 1:30:300;
% p1 =  1:50:500; p1 = sort(p1); p2 = 100:100:1000;
...
for subject = 1:Nsubjects
    ...
    parfor i = 1:L    
        ...
        %options.optLevel1.ReguAlpha = 100;
        ...
        perfSubject = perfMeasurementCV(classificationOut.labels, testFeatures.trueLabel, perfMeas);
